...
# kedro_pytorch_distributed_azure documentation build
...
from kedro_pytorch_distributed_azure import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_pytorch_distributed_azure"
author = "Kedro"
...
htmlhelp_basename = "kedro_pytorch_distributed_azuredoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_pytorch_distributed_azure.tex",
        "kedro_pytorch_distributed_azure Documentation",
        "Kedro",
        "manual",
    )
]
...
man_pages = [
    (
        master_doc,
        "kedro_pytorch_distributed_azure",
        "kedro_pytorch_distributed_azure Documentation",
        [author],
        1,
    )
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_pytorch_distributed_azure",
        "Project kedro_pytorch_distributed_azure codebase.",
        "Data-Science",
    )
]
