"""kedro-pytorch-distributed-azure file for ensuring the package is executable
as `kedro-pytorch-distributed-azure` and `python -m kedro_pytorch_distributed_azure`
"""
import importlib
